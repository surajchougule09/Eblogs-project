<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	<a class="navbar-brand" href="#"><i class="fa fa-file"
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
		...
		%>
		<a href="login.jsp" class="btn btn-light my-2 my-sm-0 mr-2" type="submit"><i class="fa fa-user-circle" aria-hidden="true"></i>
		Login</a>
